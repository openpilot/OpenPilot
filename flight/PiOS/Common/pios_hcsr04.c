...
#define PIOS_HCSR04_TRIG_GPIO_PORT                  GPIOB
#define PIOS_HCSR04_TRIG_PIN                        GPIO_Pin_6

void PIOS_HCSR04_Trigger(void)
{
	hcsr04_dev_loc->cfg->trigger.gpio->BSRR = hcsr04_dev_loc->cfg->trigger.init.GPIO_Pin;
	//PIOS_HCSR04_TRIG_GPIO_PORT->BSRR = PIOS_HCSR04_TRIG_PIN;
	PIOS_DELAY_WaituS(15);
	hcsr04_dev_loc->cfg->trigger.gpio->BRR = hcsr04_dev_loc->cfg->trigger.init.GPIO_Pin;
