 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
  ...
  */
#ifndef HSE_VALUE
# error Must define HSE_VALUE to the board oscillator frequency in Hz
#endif
...
/**
 * @brief STM32F2Xxx Standard Peripherals Library version number V1.0.0RC1
   */
...
#define __STM32F2XX_STDPERIPH_VERSION_RC     (0x01) /*!< [7:0]  release candidate */ 
