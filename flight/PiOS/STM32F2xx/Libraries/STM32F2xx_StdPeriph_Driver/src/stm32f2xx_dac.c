...
/**
  ...
  *           - DAC_Trigger: selects the trigger source: EXTI Line9, TIM2, TIM4...
  *           - DAC_WaveGeneration selects the waveform to be generated: noise, triangle.
  *           - DAC_LFSRUnmask_TriangleAmplitude: defines the LFSR  when noise waveform
  *             is selected by DAC_WaveGeneration or defines the amplitude of the triangle
  *             waveform when it is selected by DAC_WaveGeneration.
