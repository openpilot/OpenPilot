...
/**
  ...
  * @note   This function must be used when the device voltage range is from 2.1V to 2.7V.               
  * @param  Address: specifies the address to be programmed.
  *         This parameter can be any address in Program memory zone or in OTP zone.  
  * @param  Data: specifies the data to be programmed.
  * @retval FLASH Status: The returned value can be: FLASH_BUSY, FLASH_ERROR_PROGRAM,
...
/**
  ...
  * @note   This function must be used when the device voltage range is from 1.8V to 2.1V.               
  * @param  Address: specifies the address to be programmed.
  *         This parameter can be any address in Program memory zone or in OTP zone.  
  * @param  Data: specifies the data to be programmed.
  * @retval FLASH Status: The returned value can be: FLASH_BUSY, FLASH_ERROR_PROGRAM,
...
/**
  ...
  *          This parameter can be one of the following values:
  *            @arg OB_BOR_LEVEL3: Supply voltage ranges from 2.70 to 3.60 V
  *            @arg OB_BOR_LEVEL2: Supply voltage ranges from 2.40 to 2.70 V
  *            @arg OB_BOR_LEVEL1: Supply voltage ranges from 2.10 to 2.40 V
  *            @arg OB_BOR_OFF   : Supply voltage ranges from 1.62 to 2.10 V
  * @retval None
  */
void FLASH_OB_BORConfig(uint8_t OB_BOR)
{
