...
/**
  ...
  *           - GPIO_Mode: selects the pin direction mode: 
  ...
  *                        - Low speed: GPIO_Speed_2MHz
  *                        - Medium speed: GPIO_Speed_25MHz
  *                        - Fast speed: GPIO_Speed_50MHz
  *                        - High speed: GPIO_Speed_100MHz (100 MHz on 30 pF, 
  *                                      80 MHz Output max speed on 15 pF)
