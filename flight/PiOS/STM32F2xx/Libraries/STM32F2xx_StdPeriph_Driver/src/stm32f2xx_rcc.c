...
/**
  ...
  *         - After enabling the HSI, the application software should wait on
...
/**
  ...
  * @note   This clock source is common for the main PLL and PLLI2S.  
  *  
  * @param  PLLM: specifies the division factor for PLL VCO input clock
  *          This parameter must be a number between 0 and 63.
  * @note   You have to set this parameter correctly to ensure that the VCO input
  *         frequency ranges from 1 to 2 MHz. It is recommended to select a frequency
  *         of 2 MHz to limit PLL jitter.
  *  
  * @param  PLLN: specifies the multiplication factor for PLL VCO output clock
  *          This parameter must be a number between 192 and 432.
  * @note   You have to set this parameter correctly to ensure that the VCO output
  *         frequency is between 192 and 432 MHz.
  *   
  * @param  PLLP: specifies the division factor for main system clock (SYSCLK)
  *          This parameter must be a number in the range {2, 4, 6, or 8}.
  * @note   You have to set this parameter correctly to not exceed 120 MHz on
  *         the System clock frequency.
  *  
  * @param  PLLQ: specifies the division factor for OTG FS, SDIO and RNG clocks
  *          This parameter must be a number between 4 and 15.
  * @note   If the USB OTG FS is used in your application, you have to set this
  *         parameter correctly to have 48 MHz clock for the USB. However, the
...
/**
  ...
  * @note   You have to set this parameter correctly to not exceed 192 MHz on
  *         the I2S clock frequency.
  *   
  * @retval None
  */
...
====   - I2S: the I2S clock can be derived either from a specific PLL (PLLI2S) or
 ...
 +-------------------------------------------------------------------------------------+    
   (*) The operating voltage can down to 1.65 V only for CSP Package. 
