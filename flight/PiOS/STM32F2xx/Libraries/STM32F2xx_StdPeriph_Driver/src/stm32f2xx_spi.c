/**
  ...
  *   
  * @note
  *       1- This driver supports only the I2S clock scheme available in Silicon
  *          RevisionB and RevisionY.
  *     
  *       2- In I2S mode: if an external clock is used as source clock for the I2S,  
  ...
  * 
  *       3- In SPI mode: To use the SPI TI mode, call the function SPI_TIModeCmd() 
...
/**
  ...
  * @param  SPIx: To select the SPIx/I2Sx peripheral, where x can be: 
...
/**
  ...
  *            @arg I2S_FLAG_TIFRFE: Format Error.
...
/**
  ...
  *            @arg I2S_IT_TIFRFE: Format Error interrupt.  
