...
#define GRAPHICS_VDEADBAND 32
#define GRAPHICS_HDEADBAND 32

#define GRAPHICS_WIDTH_REAL 336+GRAPHICS_VDEADBAND
#define GRAPHICS_HEIGHT_REAL 270+GRAPHICS_HDEADBAND

#define GRAPHICS_WIDTH_VISIBLE GRAPHICS_WIDTH_REAL-GRAPHICS_VDEADBAND
#define GRAPHICS_HEIGHT_VISIBLE GRAPHICS_HEIGHT_REAL-GRAPHICS_HDEADBAND
