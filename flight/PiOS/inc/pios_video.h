...
#define GRAPHICS_VDEADBAND 15
#define GRAPHICS_HDEADBAND 20

#define GRAPHICS_WIDTH_REAL (320)
#define GRAPHICS_HEIGHT_REAL (260+GRAPHICS_VDEADBAND)

#define GRAPHICS_WIDTH_VISIBLE GRAPHICS_HDEADBAND
#define GRAPHICS_HEIGHT_VISIBLE GRAPHICS_VDEADBAND
