 ...
 */
typedef enum {
	EV_UNPACKED = 0x01, /** Object data updated by unpacking from telemetry or from disk */
	...
	EV_SYNCED = 0x10, /** Object data updated by unpacking after receiving from linked system */
} UAVObjEventType;
...
#define EV_MASK_ALL_UPDATES (EV_UNPACKED | EV_UPDATED | EV_UPDATED_MANUAL | EV_SYNCED)
...
int32_t UAVObjUnpack(UAVObjHandle obj, uint16_t instId, const uint8_t* dataIn, UAVObjEventType unpackevent);
