...
PathFollowerControlVelocityRoam::PathFollowerControlVelocityRoam()
    : vtolPathFollowerSettings(0), pathDesired(0), flightStatus(0), pathStatus(0), mActive(false) // ,fsm(0)
{}
...
{
  return PATHDESIRED_MODE_VELOCITYROAM;
}
...
void PathFollowerControlVelocityRoam::SettingsUpdated(void)
{
    ...
    controlThrust.UpdateParameters(vtolPathFollowerSettings->VerticalVelPID.Kp,
                                   ...
                                   1.0f, // vtolPathFollowerSettings->VerticalVelPID.Beta,
                                   dT,
 ...
 */
int32_t PathFollowerControlVelocityRoam::Initialize(PathFollowerFSM *fsm_ptr,
...
void PathFollowerControlVelocityRoam::UpdateVelocityDesired()
{
    ...
    if (((uint8_t)pathDesired->ModeParameters[PATHDESIRED_MODEPARAMETER_VELOCITYROAM_OPTIONS]) == PATHDESIRED_MODEPARAMETER_VELOCITYROAM_OPTION_HORIZONTAL_PH) {
...
int8_t PathFollowerControlVelocityRoam::UpdateStabilizationDesired(bool yaw_attitude, float yaw_direction)
{
    uint8_t result = 1;
...
void PathFollowerControlVelocityRoam::setArmedIfChanged(uint8_t val)
{
