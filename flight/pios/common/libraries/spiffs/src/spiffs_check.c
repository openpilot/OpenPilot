...
static s32_t spiffs_lookup_check_validate(spiffs *fs, spiffs_obj_id lu_obj_id, spiffs_page_header *p_hdr,
    spiffs_page_ix cur_pix, __attribute__((unused)) spiffs_block_ix cur_block, __attribute__((unused)) int cur_entry, int *reload_lu) {
  u8_t delete_page = 0;
  s32_t res = SPIFFS_OK;
  spiffs_page_ix objix_pix;
...
static s32_t spiffs_lookup_check_v(spiffs *fs, spiffs_obj_id obj_id, spiffs_block_ix cur_block, int cur_entry,
		__attribute__((unused)) u32_t user_data, __attribute__((unused)) void *user_p) {
  s32_t res = SPIFFS_OK;
...
s32_t spiffs_lookup_consistency_check(spiffs *fs, __attribute__((unused)) u8_t check_all_objects) {
  s32_t res = SPIFFS_OK;
...
s32_t spiffs_object_index_consistency_check_v(spiffs *fs, spiffs_obj_id obj_id, spiffs_block_ix cur_block,
    int cur_entry, __attribute__((unused)) u32_t user_data, void *user_p) {
