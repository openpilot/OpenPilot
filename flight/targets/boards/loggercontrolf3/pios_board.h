...
extern uint32_t pios_spi_telem_id;
extern uint32_t pios_spi_flash_id;
#define PIOS_RFM22_SPI_PORT             (pios_spi_telem_id)
#define PIOS_FLASH_SPI_PORT             (pios_spi_flash_id)
...
{                                                                                           \
	{GPIOB, GPIO_Pin_1,     ADC_Channel_3},                                                \
	{GPIOB, GPIO_Pin_2,     ADC_Channel_2},                                                \
