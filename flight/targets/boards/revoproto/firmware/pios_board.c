...
void PIOS_Board_Init(void)
{
    ...
    case HWSETTINGS_RV_AUXPORT_COMBRIDGE:
        ...
        break;
    case HWSETTINGS_RV_AUXPORT_AUXTELEMETRY:
        PIOS_Board_configure_com(&pios_usart_aux_cfg, PIOS_COM_AUXTELEM_RX_BUF_LEN, PIOS_COM_AUXTELEM_TX_BUF_LEN, &pios_usart_com_driver, &pios_com_auxtelem_id);
        break;
    ...
    case HWSETTINGS_RV_AUXSBUSPORT_COMBRIDGE:
        ...
        break;
    case HWSETTINGS_RV_AUXSBUSPORT_AUXTELEMETRY:
        PIOS_Board_configure_com(&pios_usart_auxsbus_cfg, PIOS_COM_AUXTELEM_RX_BUF_LEN, PIOS_COM_AUXTELEM_TX_BUF_LEN, &pios_usart_com_driver, &pios_com_auxtelem_id);
        break;
    } /* hwsettings_rv_auxport */
