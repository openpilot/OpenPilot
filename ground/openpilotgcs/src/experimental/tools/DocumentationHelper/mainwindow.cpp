...
void MainWindow::on_goBT_clicked()
{
    ...
    foreach(QString str, list) {
        ...
        if (ui->confirmCB->isChecked()) {
            if (QMessageBox::question(this, "Process File?:", str, QMessageBox::Yes, QMessageBox::No) == QMessageBox::No) {
                go = false;
            }
        }
        if (go) {
            ...
            if (!file.open(QIODevice::ReadWrite)) {
                ...
                if (ui->licenseCB->isChecked()) {
                    ...
                    if (!haslicense) {
                        bool process = true;
                        if (ui->confirmCB->isChecked()) {
                            if (QMessageBox::question(this, "Add license Info?:", str, QMessageBox::Yes, QMessageBox::No) == QMessageBox::No) {
                                process = false;
                            }
                        }
                        if (process) {
                ...
                if (ui->nameCB->isChecked()) {
                    ...
                    if (ui->confirmCB->isChecked() && process) {
                        if (QMessageBox::question(this, "Create Namespace?:", str, QMessageBox::Yes, QMessageBox::No) == QMessageBox::No) {
                            process = false;
                        }
                    }
                    if (process) {
