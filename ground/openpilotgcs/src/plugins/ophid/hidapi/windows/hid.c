...
int HID_API_EXPORT HID_API_CALL hid_read(hid_device *dev, unsigned char *data, size_t length, int timeout)
{
	return hid_read_timeout(dev, data, length, dev->blocking? timeout : 0);
}
