...
REM "%WixBin%\light.exe" -nologo OpenPilot.wixobj -cultures:zh_cn -loc zh_cn.wxl -dWixUILicenseRtf=license\GPLv3_zh_cn.rtf -out OpenPilot_zh_ch.msi -ext WixUtilExtension  -ext WixUIExtension
