...
ifeq ($(UNAME), Linux)
	...
	AVR_SDK_URL := http://blog.spitzenpfeil.org/arduino/mirror_released/arduino-1.6.4-linux64.tar.xz QT_SDK_URL  := http://download.qt.io/official_releases/qt/5.4/5.4.1/qt-opensource-linux-x64-5.4.1.run QT_SDK_MD5_URL := http://download.qt.io/official_releases/qt/5.4/5.4.1/qt-opensource-linux-x64-5.4.1.run.md5 QT_SDK_ARCH := gcc_64 else ARM_SDK_URL := https://launchpad.net/gcc-arm-embedded/4.9/4.9-2014-q4-major/+download/gcc-arm-none-eabi-4_9-2014q4-20141203-linux.tar.bz2 ARM_SDK_MD5_URL := https://launchpad.net/gcc-arm-embedded/4.9/4.9-2014-q4-major/+download/gcc-arm-none-eabi-4_9-2014q4-20141203-linux.tar.bz2/+md5 AVR_SDK_URL := http://blog.spitzenpfeil.org/arduino/mirror_released/arduino-1.6.4-linux32.tar.xz
...
ifeq ($(shell [ -d "$(AVR_SDK_DIR)" ] && $(ECHO) "exists"), exists)
    ...
    export AVR_SDK_PREFIX ?= avr-
endif

.PHONY: avr_sdk_version
avr_sdk_version:
	-$(V1) $(AVR_SDK_PREFIX)gcc --version | head -n1
