...
namespace gdhe {
	...
	void Client::init()
	{
		eval("clearColor 194 184 176");
		eval("set xmin -10 ; set xmax 10 ; set ymin -10 ; set ymax 10 ; set zmin -2 ; set zmax 5 ; set distmin 0 ; set distmax 10");
		eval("set obsX 0.0 ; set obsY 0.0 ; set obsZ 0.0 ; set obsElev 45 ; set obsAzi 90 ; set obsDist 2.0 ; set envDefined 1");
		eval("source $env(ROBOTPKG_BASE)/share/gdhe/tcl/camera.tcl");
	}
