...
namespace jafar {
	namespace rtslam {
		...
		void ExtendedKalmanFilterIndirect::correct(const ind_array & iax, Innovation & inn, const mat & INN_rsl, const ind_array & ia_rsl) {
			PHt_tmp = ublas::prod(ublas::project(P_, iax, ia_rsl), trans(INN_rsl));
			inn.invertCov();
