...
#define SWIG_init    Rtslam_Init
#define SWIG_name    "rtslam"
#define SWIG_prefix  "rtslam::"
#define SWIG_namespace "rtslam"
...
SWIGEXPORT int Rtslam_SafeInit(Tcl_Interp *interp) {
